...
Anthropic's official agentic coding tool. Available as a CLI, IDE extension, desktop app, and web app.

> **Sources:** https://docs.claude.com/en/docs/claude-code/overview · https://docs.claude.com/en/docs/claude-code/quickstart · https://docs.claude.com/en/docs/claude-code/cli-reference · https://docs.claude.com/en/docs/claude-code/slash-commands · https://docs.claude.com/en/docs/claude-code/ide-integrations · https://docs.claude.com/en/docs/claude-code/permissions · https://code.claude.com/docs/en/cli-reference
...
For **detailed reference** on memory, hooks, MCP, and settings precedence, see [`04-hooks-mcp-memory-settings.md`](04-hooks-mcp-memory-settings.md).
