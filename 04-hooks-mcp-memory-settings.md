# Hooks, MCP, Memory & Settings — Reference

> **Sources:** https://docs.claude.com/en/docs/claude-code/hooks · https://docs.claude.com/en/docs/claude-code/hooks-guide · https://docs.claude.com/en/docs/claude-code/mcp · https://docs.claude.com/en/docs/claude-code/memory · https://docs.claude.com/en/docs/claude-code/settings

This document covers the four primitives the harness exposes for **automating, integrating, and configuring** Claude Code.
