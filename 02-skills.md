...
> **Sources:** https://docs.claude.com/en/docs/agents-and-tools/agent-skills/overview · https://docs.claude.com/en/docs/agents-and-tools/agent-skills/best-practices · https://docs.claude.com/en/docs/agents-and-tools/agent-skills/quickstart · https://code.claude.com/docs/en/skills · https://github.com/anthropics/skills · https://agentskills.io
...
See [`06-comparison-and-decision-guide.md`](06-comparison-and-decision-guide.md) for the full decision tree.
