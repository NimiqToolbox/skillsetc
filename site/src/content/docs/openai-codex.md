---
title: OpenAI Codex
description: OpenAI's coding agent family — CLI, IDE, Cloud, GitHub. Login, AGENTS.md, slash commands, sandboxing, models, pricing, and MCP.
eyebrow: Reference
order: 6
group: reference
sources:
...
See [`06-comparison-and-decision-guide.md`](/docs/comparison-and-decision-guide) for the full side-by-side. Highlights:
