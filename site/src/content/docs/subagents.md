---
title: Subagents
description: Isolated, delegated agent contexts. Configuration, the /agents command, built-in types, invocation patterns, parallel execution, and hooks integration.
eyebrow: Reference
order: 2
group: reference
sources:
...
For more detail and the full decision tree, see [`06-comparison-and-decision-guide.md`](/docs/comparison-and-decision-guide).
